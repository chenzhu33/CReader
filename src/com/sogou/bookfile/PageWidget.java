...
//			System.out.println("ACTION_MOVE mTouch.x is = "+mTouch.x+" , mTouch.y is = "+mTouch.y);
		...
		if (event.getAction() == MotionEvent.ACTION_DOWN) {
			mTouch.x = event.getX();
			mTouch.y = event.getY();
//			System.out.println(" ACTION_DOWN mTouch.x is = "+mTouch.x+" , mTouch.y is = "+mTouch.y);
...
//		mBezierControl2.y = (mCornerX - mBezierControl1.x)*(mCornerX - mMiddleX)/(mCornerY - mMiddleY);
		
		//小米越界bug
		if(mBezierControl2.x < -1618720.8){
			mBezierControl2.x = (float) -1618720.8;
		}
		if(mBezierControl2.x > 1618720.8){
			mBezierControl2.x = (float) 1618720.8;
		}
		if(mBezierControl2.y < -1618720.8){
			mBezierControl2.y = (float) -1618720.8;
		}
		if(mBezierControl2.y > 1618720.8){
			mBezierControl2.y = (float) 1618720.8;
		}
...
//		System.out.println("--------------------------------------------------------");
//		System.out.println("");
//		System.out.println("Bstart1 is = ("+mBezierStart1.x+","+mBezierStart1.y+")");
//		System.out.println("Bstart2 is = ("+mBezierStart2.x+","+mBezierStart2.y+")");
//		System.out.println("Bcontrol1 is = ("+mBezierControl1.x+","+mBezierControl1.y+")");
//		System.out.println("Bcontrol2 is = ("+mBezierControl2.x+","+mBezierControl2.y+")");
//		System.out.println("Bvertex1 is = ("+mBeziervertex1.x+","+mBeziervertex1.y+")");
//		System.out.println("Bvertex2 is = ("+mBeziervertex2.x+","+mBeziervertex2.y+")");
//		System.out.println("Bvertex2 is = ("+mBeziervertex2.x+","+mBeziervertex2.y+")");
//		System.out.println("BEnd1 is = ("+mBezierEnd1.x+","+mBezierEnd1.y+")");
//		System.out.println("BEnd2 is = ("+mBezierEnd2.x+","+mBezierEnd2.y+")");
//		System.out.println("mTouch is = ("+mTouch.x+","+mTouch.y+")");
//		System.out.println("");
//		System.out.println("--------------------------------------------------------");
//		System.out.println("");
//		System.out.println("");
...
//		System.out.println("Orgin X is ="+mTouch.x + " and Y is = "+mTouch.y);
//		System.out.println("dx    X is ="+dx + " and Y is = "+dy);
