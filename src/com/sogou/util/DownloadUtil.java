...
public class DownloadUtil {
	...
	public List<chapter_basic> getChapterList_For_Beginread(String book_name,
			String author_name, Context c) throws Exception {
		String url = ConstData.chapter_url;
...
//		System.out.println(url);
		...
		if (statusCode == 200) {
			...
			for (int i = 0; i < jsonObjs.length(); i++) {
				...
				// ;
				chapter_basic temp_c = new chapter_basic(book_name,
			...
			// bookDao = BookDao.getInstance(c);
			book_basic book = new book_basic(book_name,
...
//				 + md5_temp+ "\n");
	...
	public boolean Begin_Read(List<chapter_basic> c_list, book_basic book,
			Context c) {
	...
	public boolean get_Bookcontext(String book_name, String author_name,
		...
		String url = ConstData.context_url;
