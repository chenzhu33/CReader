...
import com.sogou.R;
import com.sogou.adapter.BookGridAdapter;
...
public class MainNovelGrid extends Activity {
	...
	private List<book_basic> basic_list = new ArrayList<book_basic>();
		...
		gridview.setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
				...
				if (!basic_list.get(arg2).getBook_name().equals("add_a_book")
					...
					book_basic book_info = basic_list.get(position);
						...
						public void onClick(View v) {
							...
							if (booknumber < 9) {
								for (int i = booknumber; i < 9; i++) {
									book_basic addspace1 = new book_basic();
	...
	private void initGridView() {
		...
		if (basic_list == null) {
			basic_list = new ArrayList<book_basic>();
		}

		if (basic_list != null) {
			book_basic addBook = new book_basic();
