...
public class ChapterBasicBean implements Parcelable{
...
//		update_time = time_str;
	...
	public ChapterBasicBean(String book_name ,String author_name ,String chapter_name ,String chapter_md5 ,int chapter_index,int is_download) {
...
//		update_time = time_str;
	...
	public static final Parcelable.Creator<ChapterBasicBean> CREATOR = new Parcelable.Creator<ChapterBasicBean>() {  
        public ChapterBasicBean createFromParcel(Parcel in) {  
            return new ChapterBasicBean(in);  
        }  
  
        public ChapterBasicBean[] newArray(int size) {  
            return new ChapterBasicBean[size];  
        }  
    }; 
    
    private ChapterBasicBean(Parcel in) {  
