package org.carelife.creader.bean;
...
public class BookBasicBean implements Parcelable{
...
//		update_time = time_str;
	...
	public BookBasicBean(String book_name ,String author_name ,String book_md5) {
	...
	public BookBasicBean(String book_name ,String author_name ,String chapter_md5 ,int chapter_index) {
		// TODO Auto-generated constructor stub
		this.book_name = book_name;
		this.author_name = author_name;
	...
	public static final Parcelable.Creator<BookBasicBean> CREATOR = new Parcelable.Creator<BookBasicBean>() {  
        public BookBasicBean createFromParcel(Parcel in) {  
            return new BookBasicBean(in);  
        }  
  
        public BookBasicBean[] newArray(int size) {  
            return new BookBasicBean[size];  
        }  
    }; 
    
    private BookBasicBean(Parcel in) {  
