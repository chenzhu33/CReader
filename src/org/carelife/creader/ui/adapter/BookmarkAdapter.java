...
import org.carelife.creader.bean.*;
import org.carelife.creader.db.DatabaseHelper;
import org.carelife.creader.ui.activity.BookMark;
...
public class BookmarkAdapter extends BaseExpandableListAdapter {
	private List<List<BookMarkChildBean>> child_data;
	private List<BookMarkGroupBean> group_data;
	Context context;
	...
	public BookmarkAdapter(Context context ,List<BookMarkGroupBean> group_data, List<List<BookMarkChildBean>> child_data ){
	...
	public void changedata(Context context ,List<BookMarkGroupBean> group_data, List<List<BookMarkChildBean>> child_data ){
		this.context = context;
		this.child_data = child_data;
		this.group_data = group_data;
		BookmarkAdapter.this.notifyDataSetChanged();
